...
class CadastroImovelPage4 extends StatefulWidget {
  ...
  CadastroImovelPage4({Key? key, required this.tipo, required this.endereco, this.user}) : super(key: key);
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () {
                      ...
                      var numeroQuartos = _model.sliderValue1;
                      bool? switchBanheiros = _model.switchValue3;
                      var numeroBanheiros = _model.sliderValue2;
                      bool? switchVagas = _model.switchValue4;
                      var numeroVagas = _model.sliderValue3;
                      bool? switchPets = _model.switchValue5;

                      if(switchQuartos == false){
                        numeroQuartos = 0;
                      }else{
                        numeroQuartos = _model.sliderValue1;
                      }
                      if(switchBanheiros == false){
                        numeroBanheiros = 0;
                      }else{
                        numeroBanheiros = _model.sliderValue2;
                      }
                      if(switchVagas == false){
                        numeroVagas = 0;
                      }else{
                        numeroVagas = _model.sliderValue3;
                      }
                      if(switchPets = false){
                        switchPets = false;
                      }else{
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => CadastroImovelPage5(tipo: tipo, endereco: endereco, caracteristicas: formCaracteristicas, user: doc)));
                    },
                    text: 'Continuar',
